...
void energuia(long double *rx, long double *ry, long double *vx, long double *vy, long double *m, long double *ax, long double *ay, FILE *ejemplo, int filas, int columnas);

int main()
{
    long double *rx, *ry, *vx, *vy, *wx, *wy, *ax, *ay, *m;
    long double h, t;
    int filas, columnas;
    ...
    filas = 9;    // 8 + 1 planetas, se usa siempre con < en los bucles
    ...
    {   
        ...
        energuia(rx, ry, vx, vy, m, ax, ay, IBERDROLA, filas, columnas);
    }
