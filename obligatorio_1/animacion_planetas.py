...
# Parámetros
# ========================================
file_in = "salida.txt" # Nombre del fichero de datos
...
#planet_radius = 1 
planet_radius = [0, 3800000000, 20000000000, 30000000000, 15000000000, 100000000000] #, 1.23, 0.63, 0.69] # Radios de los planetas del sistema solar
