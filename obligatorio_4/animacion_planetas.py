...
#planet_radius = 1 
planet_radius = [437e5, 5e6] #, 1.23, 0.63, 0.69] # Radios de los planetas del sistema solar
planet_colors = ['#D6CF8A', 'black']
...
for frame_data_str in data_str.split("\n\n"):
    ...
    # Añade los datos de este fotograma a la lista si no está vacío
    if frame_data:
